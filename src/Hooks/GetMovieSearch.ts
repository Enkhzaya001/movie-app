...
export const getMovieSearchdApi = async (searchValue:string,page:string ) => {
    const result = await axios.get(`https://api.themoviedb.org/3/search/movie?query=${searchValue}&language=en-US&page=${page}`,
        {
            headers: {
